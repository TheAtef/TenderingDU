...
class _TenderCard extends StatelessWidget {
  ...
  void _showDeleteConfirmation(BuildContext context, MyTenderModel tender) {
    final controller = Get.find<MyTendersController>();
    final theme = ThemeController.to;
      ...
      AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Get.back();
              controller.deleteTender(tender.id);
            },
            child: const Text(
              'Delete',
              style: TextStyle(
                            ...
                            children: [
                              ...
                              Theme(
                                ...
                                child: PopupMenuButton<String>(
                                  ...
                                  onSelected: (value) {
                                    if (value == 'delete') {
                                      _showDeleteConfirmation(context, tender);
                                    }
                                  },
                                  itemBuilder: (context) => [
                                    PopupMenuItem(
